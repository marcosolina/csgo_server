...
$CSGO_INSTALL_FOLDER_FOLDER/srcds_run -game csgo -console -usercon -port 27015 +ip 192.168.1.21 +game_type 0 +game_mode 1 +mapgroup mg_marco +map de_dust2 -authkey YOUR-API-KEY +sv_setsteamaccount STEAM_CSGO_KEY -net_port_try 1